          ...
          fun i =>
            ...
            let go : GHC.Num.Integer -> GHC.Base.String -> GHC.Base.String :=
              GHC.Wf.wfFix2 Coq.Init.Peano.lt (fun arg_2__ arg_3__ =>
                               BinInt.Z.abs_nat arg_2__) _ (fun arg_2__ arg_3__ go =>
                               ...
                               | num_4__, s =>
                                   ...
                                   | i, s =>
                                       ...
                                       then GHC.Base.hs_string__ ""
                                       else let 'pair tens ones := GHC.Real.divMod i #10 in
...
(* External variables:
     ...
     GHC.Base.op_zl__ GHC.Base.ord GHC.Char.Char GHC.Char.chr GHC.Num.Integer
     GHC.Num.fromInteger GHC.Num.negate GHC.Num.op_zp__ GHC.Real.divMod
     GHC.Real.fromIntegral GHC.Wf.wfFix2
*)
